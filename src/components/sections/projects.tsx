      ...
      <div className="w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
          {projects.map((project) => (
            <Card
              key={project.title}
              className="group overflow-hidden relative shadow-lg hover:shadow-primary/20 transition-all duration-300"
            >
              <Image
                src={project.image}
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-4 md:p-6">
                ...
                <div className="absolute top-0 left-0 right-0 bottom-0 p-4 md:p-6 bg-black/80 flex flex-col justify-center items-center text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 backdrop-blur-sm">
                  ...
                  <p className="text-background mb-3 md:mb-4 text-sm md:text-base">
                    {project.description}
                  </p>
